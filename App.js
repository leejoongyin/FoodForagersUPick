    ...
    return (
      <NavigationContainer theme={LightTheme}>{
        <Stack.Navigator initialRouteName="Home" options={{isDarkmode: this.getIsDarkmode()}} screenOptions={{headerStyle: {backgroundColor: '#E2D6C8', borderBottomWidth: 0}, headerTintColor: '#442C1E', headerTitleStyle: {textAlign: 'center', marginLeft: -30}}}>
          ...
          <Stack.Screen name="RecipeSearch" component={RecipeSearch} options={{title: 'RecipeSearch'}} initialParams={{ isDarkmode: this.getIsDarkmode(), toggleDarkmode: this.toggleDarkmode.bind(this), getIsDarkmode: this.getIsDarkmode.bind(this) }}/>
        </Stack.Navigator>
      }</NavigationContainer>
    );
  }
